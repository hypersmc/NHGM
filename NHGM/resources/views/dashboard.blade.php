                  ...
                  <!--Playeronlinecontroller-->
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text">Ban appels</span>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                <span class="info-box-icon bg-success elevation-1"><i class="fa fa-life-ring"></i></span>

                                <div class="info-box-content">
                                    <span class="info-box-text">Staff Online</span>
                                    <span class="info-box-number"><!--Staffcontroller--></span>
                                </div>
                                <!-- /.info-box-content -->
                            </div>
                            <!-- /.info-box -->
